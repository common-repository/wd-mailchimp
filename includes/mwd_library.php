    ...
    <div class="mwd_upgrade wd-clear" >
				...
				switch($page){
					case "manage_mwd":	?>
						<div style="font-size: 14px; ">
								...
								<a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank" href="https://help.10web.io/hc/en-us/articles/360017853692-Configuring-API-Key"><?php _e("Read More in User Manual.","mwd-text");?></a>
						</div>                    
					<?php      
					break;
					case "manage_lists":
						if($task == 'subscriber_info'){ ?>
						  <div style="font-size: 14px;">
								...
								<a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank" href="https://help.10web.io/hc/en-us/articles/360017855532-Managing-Lists"><?php _e("Read More in User Manual.","mwd-text");?></a>
							</div> 
					...
					case "manage_forms":
						if($task == 'edit'){ ?>
						  <div style="font-size: 14px;">
								...
								<a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank" href="https://help.10web.io/hc/en-us/articles/360017853852-Form-Fields"><?php _e("Read More in User 
								Manual.","mwd-text");?></a>
							</div> 
						<?php } elseif($task == 'display_options'){ ?>
							<div style="font-size: 14px;">
								<?php _e("This section allows you to set/edit display options.","mwd-text");?>
								<a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank" href="https://help.10web.io/hc/en-us/articles/360018135371-General-Options"><?php _e("Read More in User Manual.","mwd-text");?></a>
							</div> 
						...
						<?php } else{ ?>
							<div style="font-size: 14px;">
								...
								<a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank" href="https://help.10web.io/hc/en-us/articles/360017853812-Creating-a-Form"><?php _e("Read More in User Manual.","mwd-text");?></a>
							</div> 
						<?php }   
					break;
					case "submissions_mwd":
						?>
							<div style="font-size: 14px;">
								...
								<a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank" href="https://help.10web.io/hc/en-us/articles/360018136231-Submissions"><?php _e("Read More in User Manual.","mwd-text");?></a>
							</div> 
						<?php   
					break;  
					case "themes_mwd":
						?>
						  <div style="font-size: 14px;">
								...
								<a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank" href="https://help.10web.io/hc/en-us/articles/360017854992-Themes"><?php _e("Read More in User Manual.","mwd-text");?></a>
							</div> 
						<?php
					break;     
					case "goptions_mwd":
						?>
						  <div style="font-size: 14px;">
								...
								<a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank" href="https://help.10web.io/hc/en-us/articles/360018135351-Custom-Fields"><?php _e("Read More in User Manual.","mwd-text");?></a>
							</div> 
						<?php
					break; 
					case "blocked_ips":
						?>
						  <div style="font-size: 14px;">
								...
								<a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank" href="https://help.10web.io/hc/en-us/sections/360002514911-WordPress-MailChimp-WD"><?php _e("Read More in User Manual.","mwd-text");?></a>
							</div> 
						<?php
					break;   
				}
			...
			<div class="wd-right">
				<div class="wd-table">
						...
						<div class="wd-cell wd-cell-valign-middle">
								<a href="https://10web.io/plugins/wordpress-mailchimp/?utm_source=mwd&utm_medium=free_plugin" target="_blank">
