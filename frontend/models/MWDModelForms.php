...
class MWDModelForms {
	...
	public function showform($id, $type) {
		global $wpdb;
		$form_preview = isset($_GET['form_preview']) ? (int)$_GET['form_preview'] : '';
		...
		if (isset($_GET['test_theme']) && $_GET['test_theme'] != '') {
			$theme_id = (int)$_GET['test_theme'];
		}
		else {
			$theme_id = $row->theme;
		}
...
#mwd-form".$form_id." .check-rad.mwd-right input[type='radio'] {
	...
	public function savedata($form, $id) {
		...
		if (isset($_POST["mwd-counter" . $id])) {
			$counter = sanitize_text_field($_POST["mwd-counter" . $id]);
			if (isset($_POST["mwd_captcha_input"])) {
				$mwd_captcha_input = sanitize_text_field($_POST["mwd_captcha_input"]);
			...
			elseif (isset($_POST["mwd_arithmetic_captcha_input"])) {
				$mwd_arithmetic_captcha_input = sanitize_text_field($_POST["mwd_arithmetic_captcha_input"]);
    ...
    $api_key = get_option('mwd_api_key', '');
		...
		$groupings = json_decode(sanitize_text_field(stripslashes($_POST['groupings'.$id])), true);
			...
			if(!in_array($i, $disabled_fields)) {
				switch ($type) {
					...
					case "type_submitter_mail":{
						$value = isset($_POST['wdform_'.$i."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id]) : "";
						break;
					}
					
					case "type_action":{
						$w_type = isset($_POST['w_type'.$id]) ? sanitize_text_field($_POST["w_type".$id]) : "";
						if($w_type != 'checkbox' && isset($_POST['wdform_'.$i."_element".$id])){
							$fparams['subscribe_action'] = sanitize_text_field($_POST['wdform_'.$i."_element".$id]);
							$value = sanitize_text_field($_POST['wdform_'.$i."_element".$id]);
						} else{
							for($j = 0; $j < 2; $j++) {						
								$element = isset($_POST['wdform_'.$i."_element".$id.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : NULL;
								if(isset($element)){
					...
					case "type_list":{
						$w_type = isset($_POST['w_type'.$id]) ? sanitize_text_field($_POST["w_type".$id]) : "";
						if($w_type != 'checkbox' && isset($_POST['wdform_'.$i."_element".$id])){
							$fparams['list_ids'][] = sanitize_text_field($_POST['wdform_'.$i."_element".$id]);
							$value = sanitize_text_field($_POST['wdform_'.$i."_element".$id]);
						} else{
							$value = '';
							for($j = 0; $j < $mchlists->total_items; $j++) {
								$element = isset($_POST['wdform_'.$i."_element".$id.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : NULL;
								if(isset($element)){
					...
					case "type_date_fields": {
						if(isset($_POST['wdform_'.$i."_day".$id]) || isset($_POST['wdform_'.$i."_month".$id]) || isset($_POST['wdform_'.$i."_year".$id])){
							$value = (isset($_POST['wdform_'.$i."_day".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_day".$id]) : "") . '-' . (isset($_POST['wdform_'.$i."_month".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_month".$id]) : "") . '-' . (isset($_POST['wdform_'.$i."_year".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_year".$id]) : "");
						}	
						break;
					}					
					...
					case "type_time": {
						if(isset($_POST['wdform_'.$i."_hh".$id]) || isset($_POST['wdform_'.$i."_mm".$id]) || isset($_POST['wdform_'.$i."_ss".$id])) {
							$ss = isset($_POST['wdform_'.$i."_ss".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_ss".$id]) : NULL;
							if(isset($ss)) {
								$value = (isset($_POST['wdform_'.$i."_hh".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hh".$id]) : "") . ':' . (isset($_POST['wdform_'.$i."_mm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_mm".$id]) : "") . ':' . (isset($_POST['wdform_'.$i."_ss".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_ss".$id]) : "");
							}
							else {
								$value = (isset($_POST['wdform_'.$i."_hh".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hh".$id]) : "") . ':' . (isset($_POST['wdform_'.$i."_mm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_mm".$id]) : "");
							}								
							$am_pm = isset($_POST['wdform_'.$i."_am_pm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_am_pm".$id]) : NULL;
							if(isset($am_pm)) {
								$value = $value . ' ' . $am_pm;
							}
						}
					...
					case "type_address": {
						$value = '*#*#*#';
						$element = isset($_POST['wdform_'.$i."_street1".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_street1".$id]) : NULL;
						if(isset($element)) {
							$value = array(
							  'addr1'=>sanitize_text_field($_POST['wdform_'.$i."_street1".$id]),
                'addr2'=>sanitize_text_field($_POST['wdform_'.($i+1)."_street2".$id]),
                'city'=>sanitize_text_field($_POST['wdform_'.($i+2)."_city".$id]),
                'state'=>sanitize_text_field($_POST['wdform_'.($i+3)."_state".$id]),
                'zip'=>sanitize_text_field($_POST['wdform_'.($i+4)."_postal".$id]),
                'country'=>sanitize_text_field($_POST['wdform_'.($i+5)."_country".$id]),
              );
                ...
                $merge_vars[$i] = array(
                  ...
                  'country'=>sanitize_text_field($_POST['wdform_'.($i+5)."_country".$id])
					...
					case "type_hidden": {
						$value = isset($_POST[$label_label[$key]]) ? sanitize_text_field($_POST[$label_label[$key]]) : "";
						break;
					}
					...
					case "type_radio": {
						$element = isset($_POST['wdform_'.$i."_other_input".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_other_input".$id]) : NULL;
						if(isset($element)) {
							$value = $element;	
						} else{
							$value = isset($_POST['wdform_'.$i."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id]) : "";
					...
					case "type_checkbox": {
						...
						$other_element_id = -1;
						$is_other = isset($_POST['wdform_'.$i."_allow_other".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_allow_other".$id]) : "";
						if($is_other == "yes") {
							$other_element_id = isset($_POST['wdform_'.$i."_allow_other_num".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_allow_other_num".$id]) : "";
						}
							...
							for($j = $start; $j < 300; $j++) {
								...
								if(isset($element)) {
									if($j == $other_element_id) {
										$value = $value . (isset($_POST['wdform_'.$i."_other_input".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_other_input".$id]) : "") . '***br***';
									}
									else {								
										$value = $value . (isset($_POST['wdform_'.$i."_element".$id.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : "") . '***br***';
				
										if(isset($groupings[$i])){
											if($_POST['wdform_'.$i."_element".$id.$j]){
												array_push($groupings[$i]['groups'], sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]));
												$mergeVarGroups[] = $groupings[$i];
											}
										}
									}
					...
					case "type_paypal_price":	{
						$value = isset($_POST['wdform_'.$i."_element".$id]) && $_POST['wdform_'.$i."_element".$id] ? sanitize_text_field($_POST['wdform_'.$i."_element".$id]) : 0;
						$total += (float)($value);						
						$paypal_option = array();

						if($value != 0) {
							$quantity = (isset($_POST['wdform_'.$i."_element_quantity".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_quantity".$id]) : 1);
					...
					case "type_paypal_select": {
						if(isset($_POST['wdform_'.$i."_element".$id]) && $_POST['wdform_'.$i."_element".$id] !='') {
							$value = (isset($_POST['wdform_'.$i."_element_label".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_label".$id]) : "") . ' : ' . sanitize_text_field($_POST['wdform_'.$i."_element".$id]). $form_currency;
						}
						else {
							$value = '';
						}
						...
						$quantity = (isset($_POST['wdform_'.$i."_element_quantity".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_quantity".$id]) : 1);
						$total += (float)(isset($_POST['wdform_'.$i."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id]) : 0) * $quantity;
						array_push ($paypal['item_name'], $label_label[$key] . ' ' . (isset($_POST['wdform_'.$i."_element_label".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_label".$id]) : ""));
						array_push ($paypal['quantity'], $quantity);
						array_push ($paypal['amount'], (isset($_POST['wdform_'.$i."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id]) : ""));
						if(isset($_POST['wdform_'.$i."_element".$id]) && $_POST['wdform_'.$i."_element".$id] != 0) {
							$is_amount=true;
						}
						$element_quantity = isset($_POST['wdform_'.$i."_element_quantity".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_quantity".$id]) : NULL;
						if(isset($element_quantity) && $value != '') {
							$value .= '***br***' . (isset($_POST['wdform_'.$i."_element_quantity_label".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_quantity_label".$id]) : "") . ': ' . sanitize_text_field($_POST['wdform_'.$i."_element_quantity".$id]) . '***quantity***';
						}
						$paypal_option = array();
						...
						for($k = 0; $k < 50; $k++) {
							$temp_val = isset($_POST['wdform_'.$i."_property".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_property".$id.$k]) : NULL;
							if(isset($temp_val) && $value != '') {
								array_push ($paypal_option['on'], (isset($_POST['wdform_'.$i."_element_property_label".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element_property_label".$id.$k]) : ""));
								array_push ($paypal_option['os'], (isset($_POST['wdform_'.$i."_property".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_property".$id.$k]) : ""));
								$value .= '***br***' . (isset($_POST['wdform_'.$i."_element_property_label".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element_property_label".$id.$k]) : "") . ': ' . (isset($_POST['wdform_'.$i."_property".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_property".$id.$k]) : "") . '***property***';
							}
						}
						array_push ($paypal['on_os'], $paypal_option);
						break;
					...
					case "type_paypal_radio": {
						if(isset($_POST['wdform_'.$i."_element_label".$id])) {
							$value = sanitize_text_field($_POST['wdform_'.$i."_element_label".$id]) . ' : ' . (isset($_POST['wdform_'.$i."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id]) : "") . $form_currency;
						}
						else {
							$value = '';
						}
						...
						array_push ($paypal['item_name'], $label_label[$key] . ' ' . (isset($_POST['wdform_'.$i."_element_label".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_label".$id]) : ""));
						array_push ($paypal['quantity'], $quantity);
						array_push ($paypal['amount'], (isset($_POST['wdform_'.$i."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id]) : 0));
						if(isset($_POST['wdform_'.$i."_element".$id]) && $_POST['wdform_'.$i."_element".$id] != 0) {
							$is_amount=true;
						}
						...
						for($k = 0; $k < 50; $k++) {
							...
							if(isset($temp_val) && $value != '') {
								array_push ($paypal_option['on'], (isset($_POST['wdform_'.$i."_element_property_label".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element_property_label".$id.$k]) : ""));
								array_push ($paypal_option['os'], sanitize_text_field($_POST['wdform_'.$i."_property".$id.$k]));
								$value .= '***br***' . (isset($_POST['wdform_'.$i."_element_property_label".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element_property_label".$id.$k]) : "") . ': ' . sanitize_text_field($_POST['wdform_'.$i."_property".$id.$k]) . '***property***';
							}
						}
						array_push ($paypal['on_os'], $paypal_option);
						break;
					...
					case "type_paypal_shipping": {
						$value = (isset($_POST['wdform_'.$i."_element_label".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_label".$id]) : "") . ' - ' . (isset($_POST['wdform_'.$i."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id]) : "") . $form_currency;
						$paypal['shipping'] = isset($_POST['wdform_'.$i."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id])  : "";
						break;
					}
					...
					case "type_paypal_checkbox": {
						...
						if($start != -1) {
							for($j = $start; $j < 100; $j++) {
								...
								if(isset($element)) {
									if($j == $other_element_id) {
										...
										$value = $value . (isset($_POST['wdform_'.$i."_element".$id.$j."_label"]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j."_label"]) : "") . ' - ' . (isset($_POST['wdform_'.$i."_element".$id.$j]) && $_POST['wdform_'.$i."_element".$id.$j] == '' ? '0' : (isset($_POST['wdform_'.$i."_element".$id.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : "")) . $form_currency . '***br***';
										
										
										$quantity = ((isset($_POST['wdform_' . $i . "_element_quantity" . $id]) && ($_POST['wdform_' . $i . "_element_quantity" . $id] >= 1)) ? sanitize_text_field($_POST['wdform_'.$i . "_element_quantity" . $id]) : 1);
										$total += (float)(isset($_POST['wdform_'.$i."_element".$id.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : 0) * (float)($quantity);
										array_push ($paypal['item_name'], $label_label[$key] . ' ' . (isset($_POST['wdform_'.$i."_element".$id.$j."_label"]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j."_label"]) : ""));
										array_push ($paypal['quantity'], $quantity);
										array_push ($paypal['amount'], (isset($_POST['wdform_'.$i."_element".$id.$j]) ? ($_POST['wdform_'.$i."_element".$id.$j] == '' ? '0' : sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j])) : ""));
							...
							if(isset($element_quantity)) {
								$value .= (isset($_POST['wdform_'.$i."_element_quantity_label".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_quantity_label".$id]) : "") . ': ' . sanitize_text_field($_POST['wdform_'.$i."_element_quantity".$id]) . '***quantity***';
							}
							for($k = 0; $k < 50; $k++) {
								$temp_val = isset($_POST['wdform_'.$i."_property".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_property".$id.$k]) : NULL;
								if(isset($temp_val)) {
					...
					case "type_star_rating": {
						if(isset($_POST['wdform_'.$i."_selected_star_amount".$id]) && $_POST['wdform_'.$i."_selected_star_amount".$id] == "") {
							...
							$selected_star_amount = isset($_POST['wdform_'.$i."_selected_star_amount".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_selected_star_amount".$id]) : 0;
						}						
						$value = $selected_star_amount . '/' . (isset($_POST['wdform_'.$i."_star_amount".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_star_amount".$id]) : "");
						break;
					}
			  
					case "type_scale_rating": {
						$value = (isset($_POST['wdform_'.$i."_scale_radio".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_scale_radio".$id]) : 0) . '/' . (isset($_POST['wdform_'.$i."_scale_amount".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_scale_amount".$id]) : "");
						break;
					}
					...
					case "type_slider": {
						$value = isset($_POST['wdform_'.$i."_slider_value".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_slider_value".$id]) : "";
						break;
					}
				
					case "type_range": {
						$value = (isset($_POST['wdform_'.$i."_element".$id.'0']) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.'0']) : "") . '-' . (isset($_POST['wdform_'.$i."_element".$id.'1']) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.'1']) : "");
						break;
					}
				
					case "type_grading": {
						$value = "";
						$items = explode(":", isset($_POST['wdform_'.$i."_hidden_item".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hidden_item".$id]) : "");
						for($k = 0; $k < sizeof($items) - 1; $k++) {
							$value .= (isset($_POST['wdform_'.$i."_element".$id.'_'.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.'_'.$k]) : "") . ':';
						}
						$value .= (isset($_POST['wdform_'.$i."_hidden_item".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hidden_item".$id]) : "") . '***grading***';
						break;
					}
				
					case "type_matrix": {
						$rows_of_matrix = explode("***", isset($_POST['wdform_'.$i."_hidden_row".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hidden_row".$id]) : "");
						$rows_count = sizeof($rows_of_matrix) - 1;
						$column_of_matrix = explode("***", isset($_POST['wdform_'.$i."_hidden_column".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hidden_column".$id]) : "");
						...
						if(isset($_POST['wdform_'.$i."_input_type".$id]) && $_POST['wdform_'.$i."_input_type".$id] == "radio") {
							...
							for($k = 1; $k <= $rows_count; $k++) {
								$input_value .= (isset($_POST['wdform_'.$i."_input_element".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_input_element".$id.$k]) : 0) . "***";
							}
						}
						if(isset($_POST['wdform_'.$i."_input_type".$id]) && $_POST['wdform_'.$i."_input_type".$id] == "checkbox") {
							...
							for($k = 1; $k <= $rows_count; $k++) {
								for($j = 1; $j <= $columns_count; $j++) {
									$input_value .= (isset($_POST['wdform_'.$i."_input_element".$id.$k.'_'.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_input_element".$id.$k.'_'.$j]) : 0)."***";
								}
							}
						}
						...
						if(isset($_POST['wdform_'.$i."_input_type".$id]) && $_POST['wdform_'.$i."_input_type".$id] == "text") {
							...
							for($k = 1; $k <= $rows_count; $k++) {
								for($j = 1; $j <= $columns_count; $j++) {
									$input_value .= (isset($_POST['wdform_'.$i."_input_element".$id.$k.'_'.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_input_element".$id.$k.'_'.$j]) : "") . "***";
								}
							}
						}
						...
						if(isset($_POST['wdform_'.$i."_input_type".$id]) && $_POST['wdform_'.$i."_input_type".$id] == "select") {
							...
							for($k = 1; $k <= $rows_count; $k++) {
								for($j = 1; $j <= $columns_count; $j++) {
									$input_value .= (isset($_POST['wdform_'.$i."_select_yes_no".$id.$k.'_'.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_select_yes_no".$id.$k.'_'.$j]) : "") . "***";
								}
							}
						}
				  
						$value = $rows_count . (isset($_POST['wdform_'.$i."_hidden_row".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hidden_row".$id]) : "") . '***' . $columns_count . (isset($_POST['wdform_'.$i."_hidden_column".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hidden_column".$id]) : "") . '***' . (isset($_POST['wdform_'.$i."_input_type".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_input_type".$id]) : "") . '***' . $input_value . '***matrix***';
						break;
					}
				}
              ...
              $merge_vars[$merge_var_key] = str_replace(array( "*@@url@@*", "***grading***", "***br***" ), array(
                " ",
                "",
                " ",
                " ",
	...
	public function gen_mail($counter, $all_files, $id, $str, $response_data, $subscribe_action, $updating) {
		...
		if($send_user){
			...
			$body = $new_script;
			$send_copy = isset($_POST["wdform_send_copy_".$id]) ? sanitize_text_field($_POST["wdform_send_copy_".$id]) : NULL;
			if(isset($send_copy)) {
				$send = true;
			}
			else {
		...
		if($row->reply_to) {
			$replyto = isset($_POST['wdform_'.$row->reply_to."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$row->reply_to."_element".$id]) : NULL;
			if(!isset($replyto)) {
		...
		$from = '';
		if ($row->from_mail) {
			$from = isset($_POST['wdform_'.$row->from_mail."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$row->from_mail."_element".$id]) : NULL;
			if (!isset($from)) {
				$from = $row->from_mail;
			}
			...
			if($type == "type_submit_reset" || $type == "type_editor" || $type == "type_captcha" || $type == "type_arithmetic_captcha" || $type == "type_recaptcha" || $type == "type_button")
				...
				if(!in_array($i, $disabled_fields)) {
					switch ($type) {
						...
						case "type_country":				
						case "type_number":{
							$element = isset($_POST['wdform_'.$i."_element".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id]) : NULL;
							if(isset($element)) {
						...
						case "type_hidden": {
							$element = isset($_POST[$element_label]) ? sanitize_text_field($_POST[$element_label]) : NULL;
							if(isset($element)) {
								if($this->empty_field($element, $row->mail_emptyfields)) {
									$list = $list . '<tr valign="top"><td >' . $element_label . '</td><td>' . $element . '</td></tr>';
									$list_text_mode = $list_text_mode.$element_label.' - '.$element."\r\n";
						...
						case "type_time": {							
							$hh = isset($_POST['wdform_'.$i."_hh".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hh".$id]) : NULL;
							$am_pm = isset($_POST['wdform_'.$i."_am_pm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_am_pm".$id]) : NULL;
							if(isset($hh)){
								$ss = isset($_POST['wdform_'.$i."_ss".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_ss".$id]) : NULL;
								if(isset($ss)) {
									if($this->empty_field($hh, $row->mail_emptyfields) || $this->empty_field(sanitize_text_field($_POST['wdform_'.$i."_mm".$id]), $row->mail_emptyfields) || $this->empty_field($ss, $row->mail_emptyfields)) {
										$list = $list . '<tr valign="top"><td >' . $element_label . '</td><td >' . $hh . ':' . (isset($_POST['wdform_'.$i."_mm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_mm".$id]) : "") . ':' . $ss;
										$list_text_mode = $list_text_mode.$element_label.' - '.$hh.':'.(isset($_POST['wdform_'.$i."_mm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_mm".$id]) : "").':'.$ss;
										if(isset($am_pm)) {
											$list = $list . ' ' . $am_pm . '</td></tr>';
											$list_text_mode = $list_text_mode.$am_pm."\r\n";
											$custom_fields[$i] = $hh . ':' . (isset($_POST['wdform_'.$i."_mm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_mm".$id]) : "") . ':' . $ss.  $am_pm;
										}
										else {
											$list = $list.'</td></tr>';
											$list_text_mode = $list_text_mode."\r\n";
											$custom_fields[$i] = $hh . ':' . (isset($_POST['wdform_'.$i."_mm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_mm".$id]) : "") . ':' . $ss;
										}
									}	
								}
								else {
									if($this->empty_field($hh, $row->mail_emptyfields) || $this->empty_field(sanitize_text_field($_POST['wdform_'.$i."_mm".$id]), $row->mail_emptyfields)) {
										$list = $list . '<tr valign="top"><td >' . $element_label . '</td><td >' . $hh . ':' . (isset($_POST['wdform_'.$i."_mm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_mm".$id]) : '');
										$list_text_mode = $list_text_mode.$element_label.' - '.$hh.':'.(isset($_POST['wdform_'.$i."_mm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_mm".$id]) : '');
										
										$custom_fields[$i] = $hh . ':' . (isset($_POST['wdform_'.$i."_mm".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_mm".$id]) : '');
						...
						case "type_address": {
							...
							$element = isset($_POST['wdform_'.$i."_street2".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_street2".$id]) : NULL;
							if(isset($element) && $this->empty_field($element, $row->mail_emptyfields)) {
								$list = $list . '<tr valign="top"><td >' . $label_order_original[$i] . '</td><td >' . $element . '</td></tr>';
								$list_text_mode = $list_text_mode.$label_order_original[$i].' - '.$element."\r\n";
								$custom_fields[$i] = $element;
							...
							$element = isset($_POST['wdform_'.$i."_city".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_city".$id]) : NULL;
							if(isset($element) && $this->empty_field($element, $row->mail_emptyfields)) {
								$list = $list . '<tr valign="top"><td >' . $label_order_original[$i] . '</td><td >' . $element . '</td></tr>';
								$list_text_mode = $list_text_mode.$label_order_original[$i].' - '.$element."\r\n";
								$custom_fields[$i] = $element;
							...
							$element = isset($_POST['wdform_'.$i."_state".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_state".$id]) : NULL;
							if(isset($element) && $this->empty_field($element, $row->mail_emptyfields)) {
								$list = $list . '<tr valign="top"><td >' . $label_order_original[$i] . '</td><td >' . $element . '</td></tr>';
								$list_text_mode = $list_text_mode.$label_order_original[$i].' - '.$element."\r\n";
								$custom_fields[$i] = $element;
							...
							$element = isset($_POST['wdform_'.$i."_postal".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_postal".$id]) : NULL;
							if(isset($element) && $this->empty_field($element, $row->mail_emptyfields)) {
								$list = $list . '<tr valign="top"><td >' . $label_order_original[$i] . '</td><td >' . $element . '</td></tr>';
								$list_text_mode = $list_text_mode.$label_order_original[$i].' - '.$element."\r\n";
								$custom_fields[$i] = $element;
							...
							$element = isset($_POST['wdform_'.$i."_country".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_country".$id]) : NULL;
							if(isset($element) && $this->empty_field($element, $row->mail_emptyfields)) {
								$list = $list . '<tr valign="top"><td >' . $label_order_original[$i] . '</td><td >' . $element . '</td></tr>';
								$list_text_mode = $list_text_mode.$label_order_original[$i].' - '.$element."\r\n";
								$custom_fields[$i] = $element;
						...
						case "type_date_fields": {
							$day = isset($_POST['wdform_'.$i."_day".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_day".$id]) : NULL;
							$month = isset($_POST['wdform_'.$i."_month".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_month".$id]) : "";
							$year = isset($_POST['wdform_'.$i."_year".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_year".$id]) : "";
						...
						case "type_checkbox": {
							...
							if($start != -1) {
								for($j = $start; $j < 200; $j++) {									
									...
									if(isset($element)) {
										if($j == $other_element_id) {
											$list = $list . (isset($_POST['wdform_'.$i."_other_input".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_other_input".$id]) : "") . '<br>';
											$list_text_mode = $list_text_mode.(isset($_POST['wdform_'.$i."_other_input".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_other_input".$id]) : "").', ';
											$custom_fields[$i] =  isset($custom_fields[$i]) ? $custom_fields[$i].(isset($_POST['wdform_'.$i."_other_input".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_other_input".$id]) : "").', ' : (isset($_POST['wdform_'.$i."_other_input".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_other_input".$id]) : "").', ';
										}
										else {									
											$list = $list . (isset($_POST['wdform_'.$i."_element".$id.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : "") . '<br>';
											$list_text_mode = $list_text_mode.(isset($_POST['wdform_'.$i."_element".$id.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : "").', ';
											$custom_fields[$i] = isset($custom_fields[$i]) ? $custom_fields[$i].(isset($_POST['wdform_'.$i."_element".$id.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : "") . '<br>' : (isset($_POST['wdform_'.$i."_element".$id.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : "") . '<br>';
										}
									}
								}
							}
						...
						case "type_paypal_select": {
							$value = '';
							if(isset($_POST['wdform_'.$i."_element".$id]) && $_POST['wdform_'.$i."_element".$id] != '') {
								$value = $_POST['wdform_'.$i."_element_label".$id] . ' : ' . sanitize_text_field($_POST['wdform_'.$i."_element".$id]) . $form_currency;
							
								$element_quantity_label = isset($_POST['wdform_'.$i."_element_quantity_label".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_quantity_label".$id]) : '';
								$element_quantity = (isset($_POST['wdform_'.$i."_element_quantity".$id]) && $_POST['wdform_'.$i."_element_quantity".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_element_quantity".$id]) : NULL;
								if(isset($element_quantity)) {
								...
								for($k = 0; $k < 50; $k++) {
									$temp_val = isset($_POST['wdform_'.$i."_property".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_property".$id.$k]) : NULL;
									if(isset($temp_val)) {			
										$value .= '<br/>' . (isset($_POST['wdform_'.$i."_element_property_label".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element_property_label".$id.$k]) : '') . ' : ' . $temp_val;
									}
								}
							}
						...
						case "type_paypal_shipping": {	
							$value = '';						
							if(isset($_POST['wdform_'.$i."_element".$id]) && $_POST['wdform_'.$i."_element".$id]) {
								$value = sanitize_text_field($_POST['wdform_'.$i."_element_label".$id]) . ' : ' . sanitize_text_field($_POST['wdform_'.$i."_element".$id]) . $form_currency;
							}
						...
						case "type_paypal_checkbox": {
							...
							if($start!=-1) {
								for($j = $start; $j < 200; $j++) {									
									$element = isset($_POST['wdform_'.$i."_element".$id.$j]) ? ($_POST['wdform_'.$i."_element".$id.$j] ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j]) : 0) : NULL;
									if(isset($element)) {
										$list = $list . (isset($_POST['wdform_'.$i."_element".$id.$j."_label"]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j."_label"]) : '') . ' - ' . $element. $form_currency . '<br />';
										$list_text_mode = $list_text_mode.(isset($_POST['wdform_'.$i."_element".$id.$j."_label"]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j."_label"]) : "").' - '.$element.$form_currency.', ';
										$custom_fields[$i] = $custom_fields[$i].(isset($_POST['wdform_'.$i."_element".$id.$j."_label"]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.$j."_label"]) : '') . ' - ' . $element. $form_currency . '<br />';
									}
								}
								...
								for($k = 0; $k < 50; $k++) {
									$temp_val = isset($_POST['wdform_'.$i."_element_property_value".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element_property_value".$id.$k]) : NULL;
									if(isset($temp_val)) {			
										$list = $list . (isset($_POST['wdform_'.$i."_element_property_label".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element_property_label".$id.$k]) : "") . ' : ' . $temp_val;
										$list_text_mode = $list_text_mode.(isset($_POST['wdform_'.$i."_element_property_label".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element_property_label".$id.$k]) : "") . ': ' . $temp_val.', ';
										$custom_fields[$i] = $custom_fields[$i].(isset($_POST['wdform_'.$i."_element_property_label".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element_property_label".$id.$k]) : "") . ' : ' . $temp_val.'<br />';
									}
								}
							}
							if($start != -1 || ($start == -1 && $row->mail_emptyfields)) {
						...
						case "type_paypal_total": {
							$element = isset($_POST['wdform_'.$i."_paypal_total".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_paypal_total".$id]) : '';
							if($this->empty_field($element, $row->mail_emptyfields)) {
								$list = $list . '<tr valign="top"><td >' . $element_label . '</td><td >' . $element . '</td></tr>';
								$list_text_mode = $list_text_mode.$element_label.' - '.$element."\r\n";
								$custom_fields[$i] = $element;
						...
						case "type_star_rating": {
							$element = isset($_POST['wdform_'.$i."_star_amount".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_star_amount".$id]) : NULL;
							$selected = isset($_POST['wdform_'.$i."_selected_star_amount".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_selected_star_amount".$id]) : 0;
						...
						case "type_scale_rating": {
							$element = isset($_POST['wdform_'.$i."_scale_amount".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_scale_amount".$id]) : NULL;
							$selected = isset($_POST['wdform_'.$i."_scale_radio".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_scale_radio".$id]) : 0;
							if(isset($element) && $this->empty_field($selected, $row->mail_emptyfields)) {
								$list = $list . '<tr valign="top"><td >' . $element_label . '</td><td >' . $selected . '/' . $element . '</td></tr>';	
								$list_text_mode = $list_text_mode.$element_label.' - '.$selected.'/'.$element."\r\n";
								$custom_fields[$i] = $selected.'/'.$element;
						...
						case "type_slider": {
							$element = isset($_POST['wdform_'.$i."_slider_value".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_slider_value".$id]) : NULL;
							if(isset($element) && $this->empty_field($element, $row->mail_emptyfields)) {
								$list = $list . '<tr valign="top"><td >' . $element_label . '</td><td >' . $element . '</td></tr>';
								$list_text_mode = $list_text_mode.$element_label.' - '.$element."\r\n";
								$custom_fields[$i] = $element;
						...
						case "type_range": {
							$element0 = isset($_POST['wdform_'.$i."_element".$id.'0']) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.'0']) : NULL;
							$element1 = isset($_POST['wdform_'.$i."_element".$id.'1']) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.'1']) : NULL;
						...
						case "type_grading": {
							$hidden_element = isset($_POST['wdform_'.$i."_hidden_item".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hidden_item".$id]) : '';
							...
							for($k = 0;$k < $items_count; $k++) {
								$element .= $grading[$k] . " : " . (isset($_POST['wdform_'.$i."_element".$id.'_'.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.'_'.$k]) : ' ') . ' ';
								$total += (isset($_POST['wdform_'.$i."_element".$id.'_'.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_element".$id.'_'.$k]) : 0);
						...
						case "type_matrix": {
							$input_type = isset($_POST['wdform_'.$i."_input_type".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_input_type".$id]) : "";
							$mat_rows = explode("***", isset($_POST['wdform_'.$i."_hidden_row".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hidden_row".$id]) : "");
							$rows_count = sizeof($mat_rows) - 1;
							$mat_columns = explode("***", isset($_POST['wdform_'.$i."_hidden_column".$id]) ? sanitize_text_field($_POST['wdform_'.$i."_hidden_column".$id]) : "");
							...
							for($k = 1; $k <= $rows_count; $k++) {
								...
								if($input_type == "radio") {
									$mat_radio = isset($_POST['wdform_'.$i."_input_element".$id.$k]) ? sanitize_text_field($_POST['wdform_'.$i."_input_element".$id.$k]) : 0;
									if($mat_radio == 0) {
										$checked = "";
										$aaa[1] = "";
									}
									...
									if($input_type == "checkbox") {                
										for($j = 1; $j <= $columns_count; $j++) {
											$checked = isset($_POST['wdform_'.$i."_input_element".$id.$k.'_'.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_input_element".$id.$k.'_'.$j]) : "";
											if($checked == 1) {
												$checked = "checked";
											}
											else {
										...
										if($input_type == "text") {																  
											...
											for($j = 1; $j <= $columns_count; $j++) {
												$checked = isset($_POST['wdform_'.$i."_select_yes_no".$id.$k.'_'.$j]) ? sanitize_text_field($_POST['wdform_'.$i."_select_yes_no".$id.$k.'_'.$j]) : "";
