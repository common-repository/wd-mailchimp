...
class MWDModelManage_forms {
	...
	public function get_rows_data() {
		...
		if(isset($_POST['search_select_value_type']) && (sanitize_text_field($_POST['search_select_value_type']) != '0'))
			$where[] = '`type` = "' . sanitize_text_field($_POST['search_select_value_type']) . '"';

		if(isset($_POST['search_select_value_list']) && (sanitize_text_field($_POST['search_select_value_list']) != '0'))
			$where[] = '`list_id` like "%' . sanitize_text_field($_POST['search_select_value_list']) . '%"';
	...
	public function page_nav() {
		...
		if(isset($_POST['search_select_value_list']) && (sanitize_text_field($_POST['search_select_value_list']) != '0'))
			$where[] = '`list_id` = "' . sanitize_text_field($_POST['search_select_value_list']) . '"';
