...
class MWDViewManage_lists {
    ...
    $page_nav = $this->model->page_nav('lists');
		...
		$order_by = isset($_POST['order_by']) && in_array(sanitize_text_field(stripslashes($_POST['order_by'])), $order_by_array) ? sanitize_text_field(stripslashes($_POST['order_by'])) :  'name';
    ...
    $search_value = MWD_Library::get('search_value', '');
		...
		$order_by = isset($_POST['order_by']) && in_array(sanitize_text_field(stripslashes($_POST['order_by'])), $order_by_array) ? sanitize_text_field(stripslashes($_POST['order_by'])) :  'email';
		$order_class = 'manage-column column-title sorted ' . $asc_or_desc;
