							...
							<div class="col-md-6 col-sm-5">
								...
								<div class="mwd-themes-tabs col-md-12">
									...
									<div class="mwd-themes-tabs-container">
										<div class="mwd-error col-md-12">With free version you can alter form display with Custom CSS only. Get elegant and user-friendly theme settings with Mailchimp by 10Web Pro.</div>
										<?php
										$k = 0;
