...
class MWDViewFormswdmathcaptcha {
  ////////////////////////////////////////////////////////////////////////////////////////
  // Events                                                                             //
  ////////////////////////////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////////////
	public function display() {
		if (isset($_GET['action']) && $_GET['action'] == 'Formswdmathcaptcha') {
			$i = (isset($_GET["i"]) ? (int)$_GET["i"] : '');
			...
			$operations = (isset($_GET["operations"]) ? str_replace('@', '+', sanitize_text_field($_GET["operations"])) : '+,-');
			...
			$_SESSION[$i . '_mwd_arithmetic_captcha_code'] = md5($code[1]);
