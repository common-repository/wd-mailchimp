...
10Web Forms for MailChimp is a functional plugin developed to create MailChimp subscribe/unsubscribe forms and manage MailChimp lists from your WordPress site. 

== Description ==
  
[Special Offer for all Premium Plugins](https://10web.io/wordpress-plugins/)  
[10Web Forms for MailChimp](https://10web.io/plugins/wordpress-mailchimp/)   
[Demo](https://demo.10web.io/mailchimp/)       
[User Manual](https://help.10web.io/hc/en-us/sections/360002514911-MailChimp)     

Looking for a quick and user-friendly plugin for Mailchimp integration? 10Web Forms for MailChimp plugin is developed to give you full control over your lists, signup forms, groups, email subscribers and help you grow your mailing lists and site traffic.
...
You can customize the structure of your form with Drag&Drop functionality of 10Web Forms for MailChimp. Custom CSS editor will let you edit the design of your forms which will more likely result in an effective call to action.

With Captcha field of 10Web Forms for MailChimp plugin you can secure your forms and protect them from spambots. Three types of Captcha fields are available: Simple Captcha, Arithmetic Captcha and Google ReCaptcha. You can place them to your Mailchimp email subscription forms to avoid receiving junk submissions.

In case you have received unnecessary submissions to your forms, there’s no need to worry. 10Web Forms for MailChimp plugin lets you block IP addresses, which have been bothering you. You can unblock these IPs later any time.
...
Get more by upgrading to [Pro version](https://10web.io/plugins/wordpress-mailchimp/)!
...
== Screenshots ==
1. 10Web Forms for MailChimp - MailChimp Form Example 1 
2. 10Web Forms for MailChimp - MailChimp Form Example 2     
3. 10Web Forms for MailChimp - MailChimp Form Example 3 
4. 10Web Forms for MailChimp - MailChimp Data     
5. 10Web Forms for MailChimp - MailChimp Form Edit    
6. 10Web Forms for MailChimp - MailChimp Theme Edit   

== Installation ==

#### Thank you for your interest in 10Web Forms for MailChimp.  
...
After downloading the ZIP file of the 10Web Forms for MailChimp plugin,  

1. Log in to the administrator panel.   
2. Go to Plugins Add > New > Upload.     
3. Click "Choose file" ("Browse") and select the downloaded zip file of the 10Web Forms for MailChimp plugin.     
*For Mac Users*     
*Go to your Downloads folder and locate the folder with the 10Web Forms for MailChimp plugin. Right-click on the folder and select Compress. Now you have a newly created .zip file which can be installed as described here.*     
4. Click "Install Now" button.     
5. Click "Activate Plugin" button for activating the 10Web Forms for MailChimp.    
6. If the installation does not succeed, Please contact [10Web Customer Care at WordPress.org Support Forums](https://wordpress.org/support/plugin/wd-mailchimp/).


== Frequently Asked Questions ==

= What can I achieve with 10Web Forms for MailChimp? =

10Web Forms for MailChimp is a functional plugin for integrating MailChimp forms to your WordPress site. It lets users to subscribe to your MailChimp lists. Furthermore, you can have additional form builder functionality with Custom Fields of this Mailchimp WordPress plugin.
...
10Web Forms for MailChimp has many wonderful and useful options, which make Mailchimp integration easy and help you collect subscribers and send out email newsletters. Start configuring general settings and integrate your MailChimp subscription forms to your WordPress site.
...
3. Unzip the installation folder of 10Web Forms for MailChimp **(wd-mailchimp)** and upload it to **/wp-content/plugins** directory, without modifying files.
4. Log in to WordPress administrative panel of your site and go to **Plugins** page.
5. Find 10Web Forms for MailChimp and press **Activate.**

Make sure to contact [10Web Customer Care at WordPress.org Support Forums](https://wordpress.org/support/plugin/wd-mailchimp/).

= How can I add API key to 10Web Forms for MailChimp plugin. =

After the installation is done, click on 10Web Forms for MailChimp menu item. You will need to provide MailChimp API Key, which can be created here: http://admin.mailchimp.com/account/api.

Simply press **Create Key** button from **Your API keys** section, and it will be generated. Copy the key, paste it in the input of 10Web Forms for MailChimp plugin and click **Connect to MailChimp.**

You can edit current API key from **10Web Forms for MailChimp** page. Click on **Change MailChimp API** button and paste newly generated key.
...
= How can create a form with 10Web Forms for MailChimp? =

Go to **10Web Forms for MailChimp > Forms** page to create a MailChimp form.
...
Press on the arrow from the right side to open form header settings. Here you can set a Title which will be displayed above your MailChimp form. Additionally 10Web Forms for MailChimp lets you write a few lines of Description for your email subscription form and add an image.
...
10Web Forms for MailChimp plugin allows you to include fields from more than one list in the same form. You need to mark all MailChimp lists, and their fields will be available underneath. Click once to add them to your form.
...
Pro version of 10Web Forms for MailChimp plugin also allows you to place Custom Fields to your form. You can have additional inputs, textareas, multiple and single choice fields, integrate your MailChimp form with PayPal for payments and more,and easily accomplish all your Mailchimp goals.

When the user submits, the data from custom fields is being kept in Submissions page of 10Web Forms for MailChimp. Whereas the values of the fields in your MailChimp list are being sent to your MailChimp account as well.
...
The following custom field types are provided by the plugin.
  ...
  * Multiple Choice. Lets you add a checkbox field to your 10Web Forms for MailChimp form, allowing the submitter to select more than one values.
  * Single Choice. Single Choice field of 10Web Forms for MailChimp Custom Fields allows having a list of options, users can select only one value.
  ...
  * PayPal. PayPal integration of 10Web Forms for MailChimp is a functional and useful addition for your MailChimp forms.
  ...
  * Captcha. 10Web Forms for MailChimp has word verification field (Captcha), which you can add to your form as a protection from spambots.
...
Two keys will be provided, **Public** and **Secret.** Make sure to copy them to corresponding settings in **10Web Forms for MailChimp > Global Options.**

= Is it possible to black list spammy IP addresses? =

If certain IP address is sending spam submissions through your MailChimp form, **Blocking IPs** feature of 10Web Forms for MailChimp plugin comes to rescue.
...
The list of these IPs will be available in **Blocked IPs** page of 10Web Forms for MailChimp plugin, you can add or remove IP addresses here as well, if necessary.

= How can I publish my form? =

You can publish your 10Web Forms for MailChimp form with **Embedded** view type, which comes with free version of the plugin. This view provides a shortcode of your MailChimp form. Here's an example of this shortcode:

[mwd-mailchimp id="1"]

Open a page or post, where you'd like to publish your subscription form. Click on 10Web Forms for MailChimp logo from the editor tools, select the form and click **Insert.** You can also copy this shortcode from 10Web Forms for MailChimp plugin backend and simply paste in the content.

Press **Publish** to save the page, then check out the form display on frontend by clicking **View Page.**

In Pro version of 10Web Forms for MailChimp plugin, there are additional 3 types of display options, which you can use to publish your MailChimp forms on your WordPress site:

  * Popup. In case you would like to have your 10Web Forms for MailChimp form appearing in a popup box after the pages are loaded, you can select this display option.
...
**Form Options > General Options** section lets you to configure general settings of current 10Web Forms for MailChimp form. You can publish or unpublish your form with Published option and enable or disable Saving data to your website database and Submissions section.

Themes option allows to select the theme of your form. Click Preview to check the display, or Edit to go to 10Web Forms for MailChimp Themes page.
...
10Web Forms for MailChimp uses **MailChimp Global** mailing settings. You can enable it from **Use MailChimp Globals** option in **Form Options > Email Options.** This way users and you as an admin will receive confirmation email, stating that they have been subscribed to your MailChimp list.

In Pro version of 10Web Forms for MailChimp plugin, there are advanced email settings that you can use. They are divided into the following sections:
...
To advance the functionality of your subscription form 10Web Forms for MailChimp provides a custom Javascript editor. You can access it from **Form Options > Javascript** tab.
...
If you need to display or hide some of your form fields based on certain selections made by the submitter, you can use **Conditional Fields** of 10Web Forms for MailChimp plugin. This feature is available in Pro version.
...
Go to **10Web Forms for MailChimp > Submissions** where you can find the list of your form submissions. Make sure to choose a form using **Select a Form** dropdown menu.

**Number of Entries, Conversion Rate** and **Number of Views** of this 10Web Forms for MailChimp form will display at the top, whereas the submitted data can be seen below. You can download full record of form submissions using **Export to XML** or **CSV** buttons.

= Can I filter submitted entries of 10Web Forms for MailChimp forms? =
...
Submissions of 10Web Forms for MailChimp plugin lets you customize the view of entries, in case you need to quickly check specific values. Use **Add/Remove Columns** button to exclude certain field values from display.
...
You can view your MailChimp lists by clicking on **Lists** menu item from 10Web Forms for MailChimp plugin. Open one of them to view the list of your subscribers. You can search for a specific user here, see the overview information about it and all its fields.
...
Also, the email addresses of your MailChimp list subscribers are available on **10Web Forms for MailChimp > Lists** page, under **User Emails** section.
